...
export const gameData: Record<Role, RoleData> = {
  SDE: {
    ...
    description: 'Master coding interviews, system design, and algorithmic thinking',
    icon: '💻',
    levels: [
      {
        id: 'sde-beginner',
        ...
        boss: {
          ...
          responses: {
            ...
            victory: "Impossible! A mere beginner has defeated me! Well done, future engineer!"
          }
        }
      },
      {
        ...
        boss: {
          ...
          responses: {
            ...
            victory: "Remarkable! You've outdesigned a senior architect! You're ready for the next level!"
          }
        }
      },
      {
        ...
        boss: {
          ...
          responses: {
            ...
            victory: "Inconceivable! You've surpassed even my expertise! You are a true technical leader!"
          }
        }
      }
    ]
  ...
  DS: {
    id: 'DS',
    name: 'Data Scientist',
    description: 'Conquer machine learning, statistics, and data analysis challenges',
    icon: '📊',
    levels: [
      {
        id: 'ds-beginner',
        ...
        boss: {
          ...
          responses: {
            ...
            victory: "Amazing! You've mastered the fundamentals! Ready for more complex challenges!"
          }
        }
      },
      {
        ...
        boss: {
          ...
          responses: {
            ...
            victory: "Incredible! You've outperformed a senior ML engineer! Your expertise is undeniable!"
          }
        }
      },
      {
        ...
        boss: {
          ...
          responses: {
            ...
            victory: "Unbelievable! You've surpassed even my research capabilities! You are a true AI visionary!"
          }
        }
      }
    ]
  ...
  MLE: {
    ...
    description: 'Deploy, scale, and optimize ML systems in production environments',
    icon: '⚡',
    levels: [
      {
        id: 'mle-beginner',
        ...
        boss: {
          ...
          responses: {
            ...
            victory: "Impressive! You've mastered ML deployment fundamentals! Ready for scaling challenges!"
          }
        }
      },
      {
        ...
        boss: {
          ...
          responses: {
            ...
            victory: "Remarkable! You've optimized beyond my capabilities! Your infrastructure expertise is exceptional!"
          }
        }
      },
      {
        ...
        boss: {
          ...
          responses: {
            ...
            victory: "Inconceivable! You've out-architected the master! You are the ultimate ML platform visionary!"
          }
        }
      }
    ]
